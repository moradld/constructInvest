            ...
            <div class="col-lg-5 d-flex align-items-center justify-content-center bg-white">
                <div class="w-100 px-4 px-md-5" style="max-width: 420px;">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <!-- Email -->
                        <div class="mb-3">
                            <label for="email" class="form-label auth-label text-muted">Email Address</label>
                        ...
                        <div class="d-flex align-items-center my-4">
                            ...
                            <div class="px-3 text-muted small">Or login with</div>
                            <div class="flex-grow-1 border-top"></div>
                        </div>

                        <!-- Social Buttons (UI only) -->
                        <button type="button" class="btn border w-100 py-2 mb-2 d-flex align-items-center justify-content-center gap-2 auth-social-btn">
                            <img src="{{ asset('assets/image/login/google-logo.png') }}" alt="Google" style="height: 18px; width: 18px;">
                            <span>Continue with Google</span>
                        </button>
                        <button type="button" class="btn border w-100 py-2 d-flex align-items-center justify-content-center gap-2 auth-social-btn">
                            <img src="{{ asset('assets/image/login/microsoft-logo.png') }}" alt="Microsoft" style="height: 18px; width: 18px;">
                        ...
                        <p class="text-center mt-4 small text-muted">
                            ...
                            <a href="{{ route('register') }}" class="fw-bold text-decoration-none text-primary">Sign up</a>
                        </p>
                    </form>
                </div>
            </div>
