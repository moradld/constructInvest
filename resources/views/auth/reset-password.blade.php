...
<head>
    ...
    <title>{{ __('Construct Invest - Reset Password') }}</title>
    ...
    <style>
        ...
        .auth-field-icon-left { left: 1rem; }
        .auth-field-icon-right { right: 1rem; }
        .auth-control {
            padding-left: 3rem;
            padding-right: 3rem;
        }
            ...
            <div class="col-lg-5 d-flex align-items-center justify-content-center bg-light">
                <div class="w-100 px-4 px-md-5" style="max-width: 420px;">
                    <div class="mb-4 text-center">
                        ...
                        <p class="text-muted mb-0 small">Must be at least 8 characters.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.store') }}">
                        ...
                        <!-- Password -->
                        <div class="mb-3">
                            <label for="password" class="form-label auth-label text-muted">Password</label>
                            <div class="position-relative">
                                ...
                                <input
                                    ...
                                    required
                                >
                                <button type="button" class="position-absolute top-50 translate-middle-y auth-field-icon-right auth-toggle" aria-label="Toggle password visibility" data-toggle-password="#password">
                                    <i class="bi bi-eye"></i>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="position-relative">
                                ...
                                <input
                                    ...
                                    class="form-control auth-control @error('password_confirmation') is-invalid @enderror"
                                    placeholder="Confirm your password"
                                    autocomplete="new-password"
                                    required
                                >
                                <button type="button" class="position-absolute top-50 translate-middle-y auth-field-icon-right auth-toggle" aria-label="Toggle confirm password visibility" data-toggle-password="#password_confirmation">
                                    <i class="bi bi-eye"></i>
                                    <i class="bi bi-eye-slash d-none"></i>
                                </button>
                            </div>
                    ...
                    <div class="d-flex justify-content-center gap-3 mt-5">
                        <span class="auth-step bg-success"></span>
                        <span class="auth-step bg-success"></span>
                        <span class="auth-step bg-success"></span>
                    </div>
                </div>
